        ...
        responses={
            200: OpenApiResponse(
                description=(
                    ...
                    "statement_status, chat_token, chat_agent_selected, "
                    "chat_tool_status, chat_message, chat_error, "
                    "transaction_synced, and anomaly_detected events "
                    "(named SSE `event:` types) as they occur. chat_agent_selected "
                    "(core.serializers.conversations.ChatAgentSelectedEventSerializer) "
                    "fires at most once per turn, best-effort, naming the specialist "
                    "Maestro routed to. chat_tool_status "
                    ...
                    "not depend on either for correctness. chat_error "
